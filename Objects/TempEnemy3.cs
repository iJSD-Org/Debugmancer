...
public class TempEnemy3 : KinematicBody2D
{
	...
	private void SpawnBullet()
	{
		...
		bullet1.Direction = Vector2.Down.Rotated(GetNode<Position2D>("BulletSpawns/Up1/Position2D").RotationDegrees);
		...
		bullet2.Direction = Vector2.Down.Rotated(GetNode<Position2D>("BulletSpawns/Up2/Position2D").RotationDegrees);
		...
		bullet3.Direction = Vector2.Down.Rotated(GetNode<Position2D>("BulletSpawns/Up3/Position2D").RotationDegrees);
