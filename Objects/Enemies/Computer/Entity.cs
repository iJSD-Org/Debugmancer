...
namespace Debugmancer.Objects.Enemies.Computer
{
	public partial class Entity : CharacterBody2D
	{
		...
		public void Hitbox_BodyEntered(Node2D area)
		{
		...
		{
			var bullet1 = (EnemyBullet2)_bulletScene.Instantiate();
			bullet1.Speed = _bulletSpeed;

			//UP
			bullet1.Position = Position;
			bullet1.Rotation = (float)(Math.PI / 180) * _random.Next(0, 360);
			bullet1.Direction = Vector2.Up.Rotated(GetNode<Marker2D>("BulletSpawns/Up1/Marker2D").Rotation);
			GetParent().AddChild(bullet1);

			var bullet2 = (EnemyBullet2)_bulletScene.Instantiate();
			bullet2.Speed = _bulletSpeed;

			bullet2.Position = Position;
			bullet2.Rotation = (float)(Math.PI / 180) * _random.Next(0, 360);
			bullet2.Direction = Vector2.Up.Rotated(GetNode<Marker2D>("BulletSpawns/Up2/Marker2D").Rotation);
			GetParent().AddChild(bullet2);

			var bullet3 = (EnemyBullet2)_bulletScene.Instantiate();
			bullet3.Speed = _bulletSpeed;

			bullet3.Position = Position;
			bullet3.Rotation = (float)(Math.PI / 180) * _random.Next(0, 360);
			bullet3.Direction = Vector2.Up.Rotated(GetNode<Marker2D>("BulletSpawns/Up3/Marker2D").Rotation);
			GetParent().AddChild(bullet3);

			//DOWN

			var bullet4 = (EnemyBullet2)_bulletScene.Instantiate();
			bullet4.Speed = _bulletSpeed;

			bullet4.GlobalPosition = Position;
			bullet4.Rotation = (float)(Math.PI / 180) * _random.Next(0, 360);
			bullet4.Direction = Vector2.Down.Rotated(GetNode<Marker2D>("BulletSpawns/Down1/Marker2D").Rotation);
			GetParent().AddChild(bullet4);

			var bullet5 = (EnemyBullet2)_bulletScene.Instantiate();
			bullet5.Speed = _bulletSpeed;

			bullet5.GlobalPosition = Position;
			bullet5.Rotation = (float)(Math.PI / 180) * _random.Next(0, 360);
			bullet5.Direction = Vector2.Down.Rotated(GetNode<Marker2D>("BulletSpawns/Down2/Marker2D").Rotation);
			GetParent().AddChild(bullet5);

			var bullet6 = (EnemyBullet2)_bulletScene.Instantiate();
			bullet6.Speed = _bulletSpeed;

			bullet6.GlobalPosition = Position;
			bullet6.Rotation = (float)(Math.PI / 180) * _random.Next(0, 360);
			bullet6.Direction = Vector2.Down.Rotated(GetNode<Marker2D>("BulletSpawns/Down3/Marker2D").Rotation);
			GetParent().AddChild(bullet6);

			//LEFT

			var bullet7 = (EnemyBullet2)_bulletScene.Instantiate();
			bullet7.Speed = _bulletSpeed;

			bullet7.GlobalPosition = Position;
			bullet7.Rotation = (float)(Math.PI / 180) * _random.Next(0, 360);
			bullet7.Direction = Vector2.Down.Rotated(GetNode<Marker2D>("BulletSpawns/Left1/Marker2D").Rotation);
			GetParent().AddChild(bullet7);

			var bullet8 = (EnemyBullet2)_bulletScene.Instantiate();
			bullet8.Speed = _bulletSpeed;

			bullet8.GlobalPosition = Position;
			bullet8.Rotation = (float)(Math.PI / 180) * _random.Next(0, 360);
			bullet8.Direction = Vector2.Down.Rotated(GetNode<Marker2D>("BulletSpawns/Left2/Marker2D").Rotation);
			GetParent().AddChild(bullet8);

			var bullet9 = (EnemyBullet2)_bulletScene.Instantiate();
			bullet9.Speed = _bulletSpeed;

			bullet9.GlobalPosition = Position;
			bullet9.Rotation = (float)(Math.PI / 180) * _random.Next(0, 360);
			bullet9.Direction = Vector2.Down.Rotated(GetNode<Marker2D>("BulletSpawns/Left3/Marker2D").Rotation);
			GetParent().AddChild(bullet9);

			//RIGHT

			var bullet10 = (EnemyBullet2)_bulletScene.Instantiate();
			bullet10.Speed = _bulletSpeed;

			bullet10.GlobalPosition = Position;
			bullet10.Rotation = (float)(Math.PI / 180) * _random.Next(0, 360);
			bullet10.Direction = Vector2.Down.Rotated(GetNode<Marker2D>("BulletSpawns/Right1/Marker2D").Rotation);
			GetParent().AddChild(bullet10);

			var bullet11 = (EnemyBullet2)_bulletScene.Instantiate();
			bullet11.Speed = _bulletSpeed;

			bullet11.GlobalPosition = Position;
			bullet11.Rotation = (float)(Math.PI / 180) * _random.Next(0, 360);
			bullet11.Direction = Vector2.Down.Rotated(GetNode<Marker2D>("BulletSpawns/Right2/Marker2D").Rotation);
			GetParent().AddChild(bullet11);

			var bullet12 = (EnemyBullet2)_bulletScene.Instantiate();
			bullet12.Speed = _bulletSpeed;

			bullet12.GlobalPosition = Position;
			bullet12.Rotation = (float)(Math.PI / 180) * _random.Next(0, 360);
			bullet12.Direction = Vector2.Down.Rotated(GetNode<Marker2D>("BulletSpawns/Right3/Marker2D").Rotation);
